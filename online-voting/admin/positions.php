...
<tr>
    <td style='color: #333333;'>Position Name</td>
    <td class="username"><input style="border: none;
  outline:none;
  background: none;
  font-size: 18px;
  color: #555;
  padding:20px 10px 20px 5px;" type="text" name="position" /></td>
  ...
  box-shadow: 3px 3px 8px #b1b1b1,
              -3px -3px 8px #ffffff;
  transition: 0.5s;" type="submit" name="Submit" value="Add" /></td>
</tr>
</table>
<hr>
...
<tr>
<th style='color: #333333;'>Position ID</th>
<th style='color: #333333;'>Position Name</th>
</tr>
...
echo "<tr>";
echo "<td style='color: #333333;'>" .$inc."</td>";
echo "<td style='color: #333333;'>" . $row['position_name']."</td>";
