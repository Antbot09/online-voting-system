...
<tr>
  ...
  padding-bottom: 25px;
  ">Choose Position</td>
    <td><SELECT style="margin-bottom: 30px;
 
 box-shadow: inset 8px 8px 8px #cbced1,
             inset -8px -8px 8px #ffffff;border: none;
 outline:none;
 background: none;
 font-size: 18px;
 color: #555;
 padding:20px 10px 20px 5px;" NAME="position" id="position">
  ...
  box-shadow: 3px 3px 8px #b1b1b1,
              -3px -3px 8px #ffffff;
  transition: 0.5s;" type="submit" name="Submit" value="See Results" /></td>
</tr>
<tr>
    <td>&nbsp;</td> 
    <td>&nbsp;</td>
...
<img style="" src="images/Untitled.png"
width='<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0){echo(200*round($candidate_1/($candidate_2+$candidate_1),2));}} ?>'
height='40'>
...
width='<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0){echo(200*round($candidate_2/($candidate_2+$candidate_1),2));}} ?>'
height='40'>
