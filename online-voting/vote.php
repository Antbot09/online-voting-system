...
<body bgcolor="tan">
<center>
<b><font  size="6"></font></b></center><br><br>
<body>
<div id="page">
<div id="header">
  <h1>CURRENT POLLS</h1>
...
<tr>
  ...
  font-size: 18px;
  color: #555;
  padding:20px 10px 20px 5px;" NAME="position" id="position" onclick="getPosition(this.value)">
  ...
  box-shadow: 3px 3px 8px #b1b1b1,
              -3px -3px 8px #ffffff;
  transition: 0.5s;" type="submit" name="Submit" value="See Candidates" /></td>
</tr>
<tr>
    <td>&nbsp;</td> 
    <td>&nbsp;</td>
...
echo "<td><input class='state' type='radio' name='vote' value='$row[candidate_name]' onclick='getVote(this.value)' /></td>";
echo "</tr>";
}
